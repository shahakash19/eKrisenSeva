									...
									<form action="backend/add_shelter.php" class="form-horizontal" method="POST">
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
												...
												<div class="checkbox-inline1"><label><input type="checkbox" name = "facility[]" value='3' checked=""> Sanitation</label></div>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-8"><select name="official-add" id="selector1" class="form-control1">
												<option value="1" selected>Lorem ipsum dolor sit amet.</option>
